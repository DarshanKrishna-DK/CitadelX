...
class CitadelDAO(ARC4Contract):
    ...
    def initialize_dao(
        ...
        # Validate parameters
        assert len(name.bytes) > 0, "DAO name cannot be empty"
        assert len(description.bytes) > 0, "DAO description cannot be empty"
        ...
        self.members[Txn.sender] = creator_member
    ...
    def join_dao(self, payment: gtxn.PaymentTransaction) -> String:
        ...
        existing_member, exists = self.members.maybe(Txn.sender)
        ...
        self.members[Txn.sender] = new_member
    ...
    def increase_stake(self, payment: gtxn.PaymentTransaction) -> UInt64:
        ...
        # Get existing member
        member, exists = self.members.maybe(Txn.sender)
        ...
        self.members[Txn.sender] = member
